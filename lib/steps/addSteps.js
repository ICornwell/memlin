...
var addV_Text = function addV_Text(label, props) {
  var nonObjProps = Object.keys(props).filter(function (p) {
    ...
    return "'".concat(p, "', ").concat((0, _sanitiseVal.default)(props[p]));
  }).join(', ');
  ...
  if (props) Object.keys(props).forEach(function (p) {
    if (props[p]) if (_typeof(props[p]) === 'object') {
      var keyValsList = Object.keys(props[p]).map(function (k) {
        return "'".concat(k, "', ").concat((0, _sanitiseVal.default)(props[p][k]));
      }).join(', ');
...
var addE_Text = function addE_Text(label, props) {
  ...
  if (props) Object.keys(props).filter(function (p) {
    return props[p];
  }).forEach(function (p) {
    steps.push("property('".concat(p, "', ").concat((0, _sanitiseVal.default)(props[p]), ")"));
  });
  return steps.join('.');
