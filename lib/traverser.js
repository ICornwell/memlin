...
var G = function G(args) {
  var context = {
    graph: args.initGraph ? args.initGraph : newGraph
  };
  var emptyInitialTraverser = {
    labels: [],
    objects: []
  };
  var initialisedTraversers = args.initTraversers ? args.initTraversers : [updateTraverser(emptyInitialTraverser)];
...
function isV(el) {
  return (el === null || el === void 0 ? void 0 : el.label) && (el === null || el === void 0 ? void 0 : el.id) && !el.inV;
}
