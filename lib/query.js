...
var _propertyStep = require("./steps/propertyStep");
...
function gr(anonTraversers) {
  return function (gToClone) {
    ...
    query.property = function (name, value) {
      return queryFunc(_propertyStep.property, _propertyStep.property_Text, name, value);
    };
