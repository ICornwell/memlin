...
function G() {
  ...
  g.subQuery = function (context, copyTraversers) {
    ...
    if (copyTraversers) g.context.traversers = _toConsumableArray(context.traversers);
    return g.query().traversers.map(function (t) {
      return t.objects[0];
    });
  };
  ...
  g.as = function () {
    g.query = _asSelectSteps.as.apply(void 0, arguments)(g.query);
    return g;
  };

  g.select = function () {
    g.query = _asSelectSteps.select.apply(void 0, arguments)(g.query);
    return g;
  };

  g.by = function (by) {
    g.query = by(by)(g.query);
    return g;
  };
